...
function validate_address() {
    ...
    if (add == true) {
        ...
        document.getElementById("msg4").innerHTML = "";
        document.getElementById("address").style.border = "rgb(235, 211, 219)";
        flag6=0;
    }
    else {
        document.getElementById("msg4").innerHTML = "Invalid address!";
        document.getElementById("address").style.border = "red";
        document.getElementById("address").style.border ="collapse";
